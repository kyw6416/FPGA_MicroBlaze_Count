...
HD_PWD='D:/FPGA/MicroBlaze_Count/MicroBlaze_Count.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_count_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_count_wrapper.tcl -notrace
