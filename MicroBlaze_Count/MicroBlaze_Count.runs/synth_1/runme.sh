...
HD_PWD='D:/FPGA/MicroBlaze_Count/MicroBlaze_Count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_count_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_count_wrapper.tcl
