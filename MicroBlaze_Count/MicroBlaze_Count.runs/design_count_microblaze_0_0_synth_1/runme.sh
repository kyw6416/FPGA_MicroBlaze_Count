...
HD_PWD='D:/FPGA/MicroBlaze_Count/MicroBlaze_Count.runs/design_count_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_count_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_count_microblaze_0_0.tcl
